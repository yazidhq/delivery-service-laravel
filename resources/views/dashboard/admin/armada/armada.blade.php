        ...
        <div class="align-item-end">
            <form action="{{ route('armada.store') }}" method="POST">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Jenis Kendaraan" name="nama_kendaraan">
                    <input type="text" class="form-control" placeholder="Plat Nomor" name="plat_nomor">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-sm btn-warning mx-1 rounded-2" data-toggle="modal" data-target="#editModal{{ $armada->id }}">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <!-- Modal -->
                                        <div class="modal fade" id="editModal{{ $armada->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
